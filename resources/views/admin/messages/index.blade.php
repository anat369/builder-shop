                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        @foreach($messages as $message)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('messages.edit', $message->id)}}" title="Редактировать">
                                    ...
                                    <button onclick="return confirm('Вы уверены, что хотите удалить сообщение?')" type="submit" class="btn btn-info btn-outline btn-circle btn-lg m-r-5">
